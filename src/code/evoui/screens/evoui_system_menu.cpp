...
void GuiSystemMenu::init() {
    items.clear();
    items.push_back({SystemMenuAction::RescanGames, _("Re-Scan Games"),
    ...
    items.push_back({SystemMenuAction::HardwareInfo, _("Hardware Information"), _("Controller and system information")});
