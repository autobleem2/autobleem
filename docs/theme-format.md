...
must stage at least `default`, independent of which theme is selected.
...
Themes/<name>/
  ...
  images/launcher_background.png  launcher_footer.png  play_button.png  play_text.png
         ...
         memcard_grid.png  memcard_pencil.png                 the EvolutionUI launcher (names are free
                                                              ...
                                                              autobleem-themes/tools/make_theme_images.py)
  ...
  sounds/cursor.wav  cancel.wav  home_up.wav  home_down.wav  resume_new.wav      optional - the default theme's
                                                              are generated by autobleem-themes/tools/make_theme_sounds.py
  credit.txt                                                  anything else at the root is left alone
```

## The file

`autobleem-themes/Themes/aergb/theme.json` (the submodule), with every section:
